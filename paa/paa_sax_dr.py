...
# if __name__ == "__main__":
    ...
    # X = np.array([[1,2,0,1,2,3, 3,2,1,0,2,1, 2,0,1,2,1,0], [1,2,0,1,0,2, 0,1,2,0,2,1, 2,0,-1,2,1,0]])
    # # X = np.expand_dims(X, axis=0)
    # paatf = PAASAXDR(num_intervals=3)
    ...
    # a = np.array([1,2,0,1,2,3, 3,2,1,0,2,1, 2,0,1,2,1,0])
    # print(np.sum(a>0))
