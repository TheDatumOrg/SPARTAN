...
class SFAFast():
    ...
    def fit_transform(self, X, y=None):
        ...
        from sfa._sfa_fast_numba import _transform_case,remove_repeating_words
    ...
    def transform(self, X, y=None):
        ...
        from sfa._sfa_fast_numba import _transform_case,create_bag_transform
    ...
    def transform_to_bag(self, words, word_len, y=None):
        ...
        from sfa._sfa_fast_numba import create_bag_feature_selection,create_bag_none,create_feature_names
    ...
    def _binning(self, X, y=None):
        from sfa._sfa_fast_numba import _binning_dft
    ...
    def _mcb(self, dft):
        ...
        mindist_breakpoints[0,:] = sys.float_info.min
