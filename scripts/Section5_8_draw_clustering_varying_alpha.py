...
itrs = ['a4_w4', 'a6_w4', 'a8_w4', 'a10_w4']   # shown on x-axis
ed_method_dir = 'euclidean'
ed_itr = 'euc_kmeans'

# x-tick labels
datasets = [r'$\alpha=4$', r'$\alpha=6$', r'$\alpha=8$', r'$\alpha=10$']
...
save_filename = 'bar_clustering_varying_alphabet_acc_ED_line.jpg'
